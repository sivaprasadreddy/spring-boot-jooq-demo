...
public class BookmarksRecord extends UpdatableRecordImpl<BookmarksRecord> implements Record6<Long, String, String, Long, OffsetDateTime, OffsetDateTime> {
    ...
    @Override
    public Row6<Long, String, String, Long, OffsetDateTime, OffsetDateTime> valuesRow() {
    ...
    @Override
    public BookmarksRecord value5(OffsetDateTime value) {
        setCreatedAt(value);
        return this;
    }

    @Override
    public BookmarksRecord value6(OffsetDateTime value) {
        setUpdatedAt(value);
        return this;
    }

    @Override
    public BookmarksRecord values(Long value1, String value2, String value3, Long value4, OffsetDateTime value5, OffsetDateTime value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public BookmarksRecord(Long id, String url, String title, Long createdBy, OffsetDateTime createdAt, OffsetDateTime updatedAt) {
        super(Bookmarks.BOOKMARKS);
